...
export const Sign_up = () => {
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        let registrado = await actions.singup(email, password)
        if (registrado == true) {
            ...
            <form onSubmit={handleSubmit}>
                <div className="row mb-3 my-4">
                    ...
                    <div className="col-sm-10">
                        <input type="email" className="form-control mx-3" id="inputUserNamel" />
                    </div>
                </div>
                <div className="row mb-3 my-4">
                    <label for="inputEmail3" className="col-sm-2 col-form-label text-white">Name</label>
                    <div className="col-sm-10">
                        <input type="email" className="form-control mx-3" id="inputName" />
                    </div>
                </div>
                <div className="row mb-3 my-4">
                    <label for="inputEmail3" className="col-sm-2 col-form-label text-white">LastName</label>
                    <div className="col-sm-10">
                        <input type="email" className="form-control mx-3" id="inputLastname" />
                    </div>
                </div>
                ...
                <div className="row mb-3 my-4">
                    ...
                    <div className="col-sm-10">
                        <input type="email" className="form-control mx-3" id="inputEmail3" onChange={(e) => setEmail(e.target.value)} />
                    </div>
                </div>
                <div className="row mb-3">
                    <label for="inputPassword3" className="col-sm-2 col-form-label text-white">Password</label>
                    <div className="col-sm-10">
                        <input type="password" className="form-control mx-3" id="inputPassword3" onChange={(e) => setPassword(e.target.value)} />
                    </div>
